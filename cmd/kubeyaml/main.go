...
func run(in io.Reader, out io.Writer, args ...string) error {
	...
	opts.versions = validate.String("versions", "1.18,1.17,1.16,1.15,1.14,1.13,1.12,1.11,1.10,1.9", "comma separated list of kubernetes versions to validate against")
